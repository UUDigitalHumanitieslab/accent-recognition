(function() {
    ...
    const LISTS = [
        {id: 1,
         items: [
             {id: 1, audio: 'Test1.wav', coord:[5.7201, 53.1277], place: 'Mantgum'},
             {id: 2, audio: 'Test2.wav', coord:[5.9952086699572815, 53.32903780907986], place: 'Dokkum'},
             {id: 3, audio: 'Test3.wav', coord:[5.658750368276327, 53.03662174116105], place: 'Sneek'},
         ]
        },
        {id: 2,
         items: [
             {id: 1, audio: 'Test2.wav', coord:[5.9952086699572815, 53.32903780907986], place: 'Dokkum'},
             {id: 2, audio: 'Test1.wav', coord:[5.7201, 53.1277], place: 'Mantgum'},
             {id: 3, audio: 'Test3.wav', coord:[5.658750368276327, 53.03662174116105], place: 'Sneek'},
         ]
        },
    ];
